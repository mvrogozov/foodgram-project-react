# Generated by Django 3.2.14 on 2022-08-08 07:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', through='recipes.Ingredient_for_recipe', to='recipes.Ingredient', verbose_name='Список ингредиентов')),
            ],
            options={
                'ordering': ('-created',),
            },
